...
<center><h3><b>Modificar Publicidad</b></h3></center>
<section>
      <div class="container">
        <div>
          <div class="col-md-10 col-md-offset-2">
              <div class="panel panel-primary">
                      ...
                      $opcion = $_GET['id'];
                      $result=mysqli_query($link,"SELECT * FROM publicidad_que_somos WHERE id='$opcion'");
                      $consulta = mysqli_fetch_array($result)
                      ?>

                      <table width="100%">
                      <form action="modificar_pub_empresa.php" method="post" id="frmcliente" enctype="multipart/form-data">
                        <tr class="espacio"> 
