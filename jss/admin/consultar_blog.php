...
<section>
     ...
     <center><h1><b>PUBLICIDAD de blogs</b></h1></center>
<section>
      <div class="container">
        <table class="table table-striped">
            <thead>
            ...
            <tbody>
                <?php 
                require_once('../../conexion.php');
                    $sql = "SELECT * FROM publicidad_blog";
                    $result = $conexion->query($sql);
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['descripcion']; ?></td>
                        <td>
                            <center><a href="modificar_pub_blog.php?id=<?php echo $row['id']; ?>"><img width="32px" height="32px" src="../images/editar.png"></a><center>
                        </td>
                        <td>
    ...
    if (aceptar) 
    {
    document.location="eliminar_publicidad_blog.php?opcion="+id;
    }
    else{
