...
include('../header.html');
 ?>
  ...
  <center><h3><b>Consulta y Modificacion de datos de la imagenes de paquetes index</b></h3></center>
<section>
    ...
    <?php
      ...
      $result = mysqli_query($link, "SELECT * FROM imagen_index_slider");
      ...
      echo "<tr>
                  ...
                  <th class='success'><center>Segunda descripción de la imagen</center></th>
                  <th class='success'><center>Lugar</center></th>
                  <th class='success'><center>Personas</center></th>
                  <th class='success'><center>Duración</center></th> 
            ...
            <td class='active'><center>$descripcion2</center></td>
            <td class='active'><center>$Lugar</center></td>
            <td class='active'><center>$personas</center></td>
            <td class='active'><center>$duracion</center></td>
            <td class='active'><center><a href='modificar_ini.php?id=$id'><img  width='32px' height='32px' src='../images/editar.png'/></center></a></td>
